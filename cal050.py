...
#
encabezados = {
            'A': 'fila','B': 'codigo', 'D': 'geo_x', 'E': 'geo_y','F': 'geo_z', 'G': 'provincia', 'H': 'canton',
            'I': 'subestacion', 'J': 'alimentador', 'M': 'ff', 'N': 'fn', 'O': 'fecha_inicio', 'P': 'hora_inicio',
            ...
            'AK': 'fa12dv13', 'AL': 'fa13dv14', 'AM': 'fa14dv15', 'AN': 'fa15dv','AN': 'fa15dv','AO':'total_a', 'AP': 'fb5dv6', 'AQ': 'fb6dv7', 'AR':'fb7dv8',
            'AS': 'fb8dv9', 'AT': 'fb9dv10', 'AU':'fb10dv11', 'AV':'fb11dv12', 'AW': 'fb12dv13', 'AX':'fb13dv14',
            'AY': 'fb14dv15', 'AZ': 'fb15dv','BA':'total_b', 'BB':'fc5dv6', 'BC': 'fc6dv7', 'BD':'fc7dv8', 'BE':'fc8dv9', 'BF':'fc9dv10',
...
def calcular50(path_source,path_final):
    ...
    workbook = load_workbook('./plantillas/cal50_consolidado.xlsx')
    ...
    for i in data_ordenada:
        ...
        sheet[f'J{aux_init}'] = i['subestacion']
        sheet[f'K{aux_init}'] = i['alimentador']
